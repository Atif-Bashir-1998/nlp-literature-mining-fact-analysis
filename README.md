...
|---------------|----------------|--------------------|
| 1,2,3,4 | `01_run_data_collection.py` | `literature_analysis/papers`: Defined research scope. Papers are retrieved automatically. PDFs are downloaded. Metadata extraction |
| 5 | `02_descriptive_analysis.py` | `literature_analysis/visualizations`: Exploratory data analysis |
| 6 | `literature_miner.py` | A class to handle literature mining related utilities and text preprocessing utilities |
| 7 | `03_text_mining_analysis.py` | `literature_analysis/text_analysis` Topic Modeling & Clustering |
