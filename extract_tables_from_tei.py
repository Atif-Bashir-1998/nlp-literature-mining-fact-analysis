...
# CONFIGURATION
# ------------------------------
tei_dir = r"C:\Users\hp830\Desktop\OULU\University\Projects\NLP_Project\paper_tei_files"  # folder containing TEI XML files
output_dir = r"C:\Users\hp830\Desktop\OULU\University\Projects\NLP_Project\tables_output"
...
if not tei_files:
    print("⚠️ No TEI XML files found in the directory.")
else:
...
for tei_file in sorted(tei_files):
    ...
    try:
        ...
        if not tables:
            print(f"⚠️ No tables found in {tei_file}.")
            continue
